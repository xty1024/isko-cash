...
momentum = angular.module "Momentum", [
  ...
  "Momentum.directives"
  "Momentum.txncontrollers"
  "Momentum.lostcardcontrollers"
  "Momentum.balcontrollers"
  "Momentum.itemcontrollers"
]

momentum.config ["$routeProvider", "$locationProvider", ($routeProvider, $locationProvider) ->
